...
![Figure 02 at BMW's Spartanburg plant — the first humanoid robot to complete an extended factory deployment, working 10-hour shifts alongside human workers. Photo: BMW Group Press.](figure02-bmw-official.jpg){#fig-hero}
...
In 2023, [Diffusion Policy](../1-diffusion-policy/) showed that the same technique generating Stable Diffusion images could teach robots to move — and outperformed everything before it by 46.9%. Two years later, it's still the foundation of nearly every state-of-the-art system.
...
- [My Diffusion Policy Deep Dive](../1-diffusion-policy/) — Technical explanation
- [Diffusion Series](../../diffusion/1-intro/) — Mathematical foundations
