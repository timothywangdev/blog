...
$$
\begin{aligned}
\textcolor{blue}{\frac{dX_t}{dt}} &= \textcolor{green}{u_t}(\textcolor{orange}{X_t}) \\
X_0 &= x_0 \quad (\text{initial condition})
\end{aligned}
$$ {#eq-vector-field}

where $\textcolor{blue}{\text{velocity}}$ equals the $\textcolor{green}{\text{vector field}}$ evaluated at your $\textcolor{orange}{\text{current position}}$.
...
$$
\begin{aligned}
\textcolor{blue}{\frac{dX_t}{dt}} = \textcolor{green}{u_t}(\textcolor{orange}{X_t}) \implies \textcolor{blue}{\frac{d \phi_t(x_0)}{dt}} = \textcolor{green}{u_t}(\textcolor{orange}{\phi_t(x_0)}) \\
