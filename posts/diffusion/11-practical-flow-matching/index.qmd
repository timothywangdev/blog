...
See the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the complete implementation. The setup code is in the `setup` cell.
...
See the `data-loading` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for data loading code.
...
See the `unet-architecture` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the full U-Net configuration.
...
The implementation is straightforward — sample $t$, compute $x_t$, and minimize MSE between predicted and target vector field. See the `flow-matching-loss` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the complete implementation.
...
See the `cfg-implementation` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the `CFGVelocityWrapper` class that applies this formula during sampling.
...
See the `training-loop` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the complete training code.
...
See the `sampling` cell in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for the complete sampling implementation.

## Results

After training, we can generate images for any CIFAR-10 class. See the `results` and `guidance-comparison` cells in the [companion notebook](https://github.com/timothywangdev/blog/blob/master/posts/diffusion/11-practical-flow-matching/notebook.ipynb) for generated samples and visualizations.
