...
**Note on text conditioning**: For free-form text prompts (not class labels), cross-attention works better than AdaLN. This is what Stable Diffusion uses — the text encoder outputs a sequence of embeddings, and each DiT block cross-attends to them.
...
3. **Compute distance**: Calculate the Fréchet distance between the two Gaussians:
   ...
   where $(\mu_r, \Sigma_r)$ and $(\mu_g, \Sigma_g)$ are the mean/covariance of real and generated features
