...
| **Part 6** | [Score Matching](../6-score-matching/) | The score function, probability flow ODE, and the connection |
...
- [**Part 6**](../6-score-matching/): We'll learn score matching and connect diffusion to flow matching
