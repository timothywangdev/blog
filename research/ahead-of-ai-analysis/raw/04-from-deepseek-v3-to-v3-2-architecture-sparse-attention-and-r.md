...
**Subtitle:** Understanding How DeepSeek's Flagship Open-Weight Models Evolved
...
1. ![Figure](https://substackcdn.com/image/fetch/$s_!JN06!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff841a4f1-8524-4e3a-98f2-b9bf65072819_2113x1459.png)
   - Caption: Figure 1: Benchmark comparison between DeepSeek V3.2 and proprietary flagship models. This is an annotated figure from the DeepSeek V3.2 report.

2. ![Figure](https://substackcdn.com/image/fetch/$s_!W4Qo!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff4b97110-d705-4531-b4af-4f87187a8dea_1393x1394.png)
   - Caption: Figure 2: DeepSeek V3/R1 architecture from December 2024. We will revisit and discuss architectural details in a later section.

3. ![Figure](https://substackcdn.com/image/fetch/$s_!4LZs!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F56649604-b822-47a2-a3fc-169ec453ae17_1414x446.png)
   - Caption: Figure 3: DeepSeek releases since last year. The main models are shown in red.

4. ![Figure](https://substackcdn.com/image/fetch/$s_!maHo!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F269735af-5f6c-4a6f-b9f4-56b6d2d4d41f_1754x1322.png)
   - Caption: Figure 4: Overview of the DeepSeek R1 training pipeline. This figure is from my more detailed Understanding Reasoning LLMs article.

5. ![Figure](https://substackcdn.com/image/fetch/$s_!qqkY!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda512f7b-5a41-49c1-8a76-ff74fa065972_1145x928.png)
   - Caption: Figure 5: The timeline of some of the reasoning and hybrid models released this year.

6. ![Figure](https://substackcdn.com/image/fetch/$s_!8R3i!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5d55cf9d-7855-4802-b7de-61971cd02f38_1623x1527.png)
   - Caption: Figure 6: Multi-Head Latent Attention (MLA) in DeepSeek V3/R1. (The compressed space of the query vector is not shown for simplicity.)

7. ![Figure](https://substackcdn.com/image/fetch/$s_!12jb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4848890b-e00b-468f-880d-27ee5db5fb3a_1277x619.png)
   - Caption: Figure 7: An example of a verifiable task.

8. ![Figure](https://substackcdn.com/image/fetch/$s_!dNxH!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe798b5b2-b489-485f-8b89-6043f3029d02_2019x1142.png)
   - Caption: Figure 8: Comparison of reinforcement learning setups in LLM training. Traditional RLHF with PPO uses both a reward model (trained on human preferences) and a critic (value model) to guide learning. GRPO eliminates the critic model. RLVR with GRPO goes a step further by removing the reward model, relying instead on verifiable rewards from symbolic tools such as calculators or compilers.

9. ![Figure](https://substackcdn.com/image/fetch/$s_!IwOF!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0a4f4aa7-39fb-4c7d-8c25-a7643475a1c6_799x418.png)
   - Caption: Figure 9: In sliding window attention, the current query token doesn’t attend to all previous tokens but just a subset.

10. ![Figure](https://substackcdn.com/image/fetch/$s_!oxpT!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faabfcdab-fd13-44f8-94d9-e8fd27cd48b4_815x424.png)
   - Caption: Figure 10: In DSA, the current token can attend a select number of tokens in the past (instead of all tokens like in regular causal attention).

11. ![Figure](https://substackcdn.com/image/fetch/$s_!tSrP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F763113a8-3405-4c48-9d24-35a35bf29e4e_1388x928.png)
   - Caption: Figure 11: A visual summary of DeepSeek V3.2’s Sparse Attention mechanism.

12. ![Figure](https://substackcdn.com/image/fetch/$s_!MVTj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fef977cde-cec9-4f7c-a805-b450d01f9e54_1907x1195.png)
   - Caption: Figure 12: The general math proof generator (LLM 1) and verifier (LLM 2) setup.

13. ![Figure](https://substackcdn.com/image/fetch/$s_!ITiX!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe8da9860-f197-4f9f-8af9-aa055de71dc5_2404x1397.png)
   - Caption: Figure 13: The meta-verifier (LLM 3) checks whether the verifier (LLM 2) is verifying the generator (LLM 1) correctly.

14. ![Figure](https://substackcdn.com/image/fetch/$s_!HFcU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5899b054-e704-47a0-85e4-58dc217db84a_1907x1494.png)
   - Caption: Figure 14: A classic self-refinement iteration where we use the same LLM for generating the initial response (Output 1), the evaluation (Eval), and the refined answer (Output 2).

15. ![Figure](https://substackcdn.com/image/fetch/$s_!shTj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a02acb6-813c-40f0-89ed-0b1025a3c465_1907x1494.png)
   - Caption: Figure 15: Self-refinement with a separate verifier LLM (LLM 2).

16. ![Figure](https://substackcdn.com/image/fetch/$s_!Cmee!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F89a882b5-ebca-442f-9bef-1a5ef1b4c570_1619x992.png)
   - Caption: Figure 16: Additional self-refinement iterations improve accuracy. Annotated figure from the DeepSeekMath V2 paper. The Best@32 accuracy majority voting method is also known as “self-consistency” and covered in Chapter 4 of my Build a Reasoning Model (From Scratch) book .

17. ![Figure](https://substackcdn.com/image/fetch/$s_!JN06!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff841a4f1-8524-4e3a-98f2-b9bf65072819_2113x1459.png)
   - Caption: Figure 17: Benchmark comparison between DeepSeek V3.2 and proprietary flagship models. This is an annotated figure from the DeepSeek V3.2 report.

18. ![Figure](https://substackcdn.com/image/fetch/$s_!dm8C!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F08cd373b-6a67-429e-82ba-dc5758841b38_809x1336.png)
   - Caption: Figure 18: The DeepSeek V3.2 architecture.

19. ![Figure](https://substackcdn.com/image/fetch/$s_!j_TQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F67afa7ab-07b8-4e78-afb6-136ae0b6fa54_1445x804.png)
   - Caption: Figure 19: Inference cost savings thanks to DeepSeek Sparse Attention (DSA). Annotated figure from the DeepSeek V3.2 report.

20. ![Figure](https://substackcdn.com/image/fetch/$s_!QaOn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff87eee11-3aaa-41c4-b45a-51b5c865a5ae_1131x574.png)
   - Caption: Figure 20: The “extended-thinking” Speciale model achieves higher accuracy but also generates more tokens.

21. ![Figure](https://substackcdn.com/image/fetch/$s_!cQTW!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7e9fe8ab-954c-4495-9150-0fb67176c5bd_1890x1352.png)
   - Caption: Figure 21: Illustration of the mHC approach. Subfigure on the right is an annotated figure from the mHC paper.

22. ![Figure](https://substackcdn.com/image/fetch/$s_!RCl_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27a118a0-5da6-4486-b1f0-3743754d0a77_8106x4044.webp)
...
Figure 16: Additional self-refinement iterations improve accuracy. Annotated figure from the DeepSeekMath V2 paper. The Best@32 accuracy majority voting method is also known as “self-consistency” and covered in Chapter 4 of my Build a Reasoning Model (From Scratch) book .
...
Figure 21: Illustration of the mHC approach. Subfigure on the right is an annotated figure from the mHC paper.
