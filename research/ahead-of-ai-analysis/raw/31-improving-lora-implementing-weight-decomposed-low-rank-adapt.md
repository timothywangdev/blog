...
1. ![Figure](https://substackcdn.com/image/fetch/$s_!6HOU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3648f6eb-ddbf-4201-9cad-454789f35509_1370x874.png)
   - Caption: DoRA is a promising alternative to standard LoRA (annotated figure from the DoRA paper: https://arxiv.org/abs/2402.09353)

2. ![Figure](https://substackcdn.com/image/fetch/$s_!Fk3V!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fee7f7d37-3c0a-4f4a-9244-f73287af6211_1456x612.jpeg)

3. ![Figure](https://substackcdn.com/image/fetch/$s_!wMom!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa11d59f4-a948-42de-a791-114d719f08f1_566x680.png)
   - Caption: Illustration of the LoRA matrices A and B with rank r.

4. ![Figure](https://substackcdn.com/image/fetch/$s_!FOLT!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffd61c168-2fd6-4b2f-b1ef-50e4da5a63e3_652x676.png)
   - Caption: LoRA applied to an existing linear layer

5. ![Figure](https://substackcdn.com/image/fetch/$s_!866i!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24331b05-95b4-4ea0-aa96-d035a929a932_632x926.png)
   - Caption: A simple 3-layer multilayer perceptron

6. ![Figure](https://substackcdn.com/image/fetch/$s_!pv7G!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6a5bf344-2c27-4197-839f-6c28af722e0f_766x614.png)
   - Caption: Illustration of the direction and magnitude of a single vector. For example, if have a 2D vector [1, 2], we can decompose it into a magnitude 2.24 and a directional vector [0.447, 0.894]. Then 2.24 * [0.447, 0.894] = [1, 2].

7. ![Figure](https://substackcdn.com/image/fetch/$s_!aVuN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd07991e9-b89a-44f9-bba3-03bb7cb41288_1370x800.png)
   - Caption: Illustration of the weight matrix decomposition in DoRA

8. ![Figure](https://substackcdn.com/image/fetch/$s_!LV-y!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa273632c-9434-43d1-9156-fb6d58a1a26e_1600x1137.png)
   - Caption: Annotated illustration from the DoRA paper (https://arxiv.org/abs/2402.09353)

9. ![Figure](https://substackcdn.com/image/fetch/$s_!DDex!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27c269b8-e0cc-4be0-a5d3-bd2a79ac7f29_1600x368.png)
   - Caption: Comparison between LoRA and DoRA from the DoRA paper (https://arxiv.org/abs/2402.09353)

10. ![Figure](https://substackcdn.com/image/fetch/$s_!ejBJ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24fbe197-dbbe-4bd5-b25f-59970b19ad44_1444x910.png)
   - Caption: DoRA is more robust to the rank hyperparameter than LoRA (annotated figure from the DoRA paper, https://arxiv.org/abs/2402.09353)

11. ![Figure](https://substackcdn.com/image/fetch/$s_!CpnG!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3d3550b9-14a6-4a1d-844d-d72c1bfceed3_1600x488.png)
   - Caption: File-diff between LinearWithLoRAMerged and LinearWithDoRAMerged

12. ![Figure](https://substackcdn.com/image/fetch/$s_!3qw2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F719ec33a-00f2-4542-a539-e3905574621e_1568x1146.png)
   - Caption: DoRA code notebook: https://github.com/rasbt/dora-from-scratch

13. ![Figure](https://substackcdn.com/image/fetch/$s_!woQp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fea1152a0-18d9-4a8a-9398-c6b1ca67726a_1600x900.png)
...
Last week, researchers proposed DoRA: Weight-Decomposed Low-Rank Adaptation, a new alternative to LoRA, which may outperform LoRA by a large margin.
...
The LoRA method proposed by Hu et al. offers a more efficient alternative to computing the weight updates ΔW by learning an approximation of it, ΔW ≈ AB. In other words, in LoRA, we have the following, where A and B are two small weight matrices:
...
The normalization, which I abbreviated as "norm" to not further complicate things in this overview, is based on the weight normalization method proposed in Saliman's and Kingma's 2016 Weight Normalization: A Simple Reparameterization to Accelerate Training of Deep Neural Networks paper.
...
Comparison between LoRA and DoRA from the DoRA paper (https://arxiv.org/abs/2402.09353)

As I wrote in another article a few months ago, LoRA requires careful tuning of the rank to optimize performance: Practical Tips for Finetuning LLMs Using LoRA (Low-Rank Adaptation). However, DoRA seems to be much more robust to changes in rank, as shown in the comparison below.
...
In this section, we will see what DoRA looks like in code. Previously, we said that we can initialize a pretrained weight W0 with magnitude m and directional component V. For instance, we have the following equation:
...
Now, in the DoRA paper, the authors formulate DoRA as follows, where they use the initial pretrained weights W0 as the directional component directly and learn magnitude vector m during training:
