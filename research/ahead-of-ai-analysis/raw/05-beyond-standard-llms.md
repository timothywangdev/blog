...
**Subtitle:** Linear Attention Hybrids, Text Diffusion, Code World Models, and Small Recursive Transformers
...
1. ![Figure](https://substackcdn.com/image/fetch/$s_!gTFK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fee4ebedc-268b-4bd4-ae4c-61e894f4b8d9_1137x574.png)
   - Caption: Figure 1: Overview of the LLM landscape. This article covers those architectures surrounded by the black frames. The decoder-style transformers are covered in my “The Big Architecture Comparison” article. Other non-framed architectures may be covered in future articles.

2. ![Figure](https://substackcdn.com/image/fetch/$s_!HSi2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc589dd95-6a69-4629-8775-93294f5f670b_1136x577.png)
   - Caption: Figure 2: An overview of the most notable decoder-style transformers released in the past year.

3. ![Figure](https://substackcdn.com/image/fetch/$s_!dEOx!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F184d4826-1891-4b7f-b7f5-5e59884fea3d_1600x1107.png)
   - Caption: Figure 3. A subset of the architectures discussed in my The Big Architecture Comparison (https://magazine.sebastianraschka.com/p/the-big-llm-architecture-comparison) article.

4. ![Figure](https://substackcdn.com/image/fetch/$s_!Eihw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F911104df-2916-4ab7-a64a-afc4aee26400_1845x2009.png)
   - Caption: Figure 4: Illustration of the traditional scaled-dot-product attention mechanism in multi-head attention; the quadratic cost in attention due to sequence length n.

5. ![Figure](https://substackcdn.com/image/fetch/$s_!wJGD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a7152e0-02e6-4d23-b356-7e9369ded9b2_970x398.png)
   - Caption: Figure 5: An overview of the linear attention hybrid architectures.

6. ![Figure](https://substackcdn.com/image/fetch/$s_!xG2P!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F79f40ad3-3eb3-4e1b-83fe-020b004b8b35_1170x1540.png)
   - Caption: Figure 6: Qwen3-Next with gated attention and Gated DeltaNet.

7. ![Figure](https://substackcdn.com/image/fetch/$s_!PkGK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0e481e44-c698-4e73-895b-aa933d0f5644_2048x1128.png)
   - Caption: Figure 7: A previous “regular” Qwen3 model (left) next to Qwen3-Next (right).

8. ![Figure](https://substackcdn.com/image/fetch/$s_!1ivU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F43000e1f-3d9c-43fa-a8d9-0336704edc9d_1282x4032.png)

9. ![Figure](https://substackcdn.com/image/fetch/$s_!b6G_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa3532f29-b383-4b9e-a304-ce08113eada5_1142x1622.png)
   - Caption: Figure 8: Gated attention compared to Gated DeltaNet.

10. ![Figure](https://substackcdn.com/image/fetch/$s_!6j_I!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce616817-98d0-4d19-8d22-5654879830e9_1291x4072.png)

11. ![Figure](https://substackcdn.com/image/fetch/$s_!3HPw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5dcebeec-cba5-4b0a-be49-c30d1a8c6033_1844x2008.png)
   - Caption: Figure 9: The traditional attention mechanism (again), which scales with the number of tokens n.

12. ![Figure](https://substackcdn.com/image/fetch/$s_!3qXH!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F841c5546-1ddd-49bd-8cae-8043a8916f3c_814x483.png)

13. ![Figure](https://substackcdn.com/image/fetch/$s_!Ar25!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda0a6fe5-b29d-46ce-ab64-6096a67accd1_2048x1293.png)
   - Caption: Figure 10: A comparison of the growing KV cache size. The 3:1 ratio refers to the ratio of Gated DeltaNet to full attention layers. The calculation assumes emb_dim=2048, n_heads=16, n_layers=48, bf16. You can find the code to reproduce this here: https://github.com/rasbt/LLMs-from-scratch/tree/main/ch04/08_deltanet.

14. ![Figure](https://substackcdn.com/image/fetch/$s_!PPbS!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6821ea8a-32bd-45d8-8531-511f4e8a5e28_2048x1343.png)
   - Caption: Figure 11: Qwen3-Next and Kimi Linear side by side.

15. ![Figure](https://substackcdn.com/image/fetch/$s_!bI80!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2c561bf0-3aec-4ebf-bb9a-27e8f4c2b20e_759x679.png)
   - Caption: Figure 12: Annotated figure from the Kimi Linear paper (https://arxiv.org/abs/2510.26692) showing that Kimi Linear is as fast as GatedDeltaNet, and much faster than an architecture with multi-head latent attention (like DeepSeek V3/R1), while having a higher benchmark performance.

16. ![Figure](https://substackcdn.com/image/fetch/$s_!HpL1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F40e75460-230a-4cf0-ad29-87e4f6da35b7_2048x378.png)
   - Caption: Figure 13: Illustration of an image diffusion process from my very first Substack article in 2022. Here, Gaussian noise is added from left to right, and the model’s task is to learn how to remove the noise (from right to left).

17. ![Figure](https://substackcdn.com/image/fetch/$s_!YHTA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb9529dd9-60cb-492f-9332-b3404110fd57_1136x574.png)
   - Caption: Figure 14: This section covers text diffusion models.

18. ![Figure](https://substackcdn.com/image/fetch/$s_!PyYP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F476348a3-03e7-489d-ab1d-81ad87963f99_800x450.gif)
   - Caption: Figure 15: Illustration of the denoising process using the 8B LLaDA model.

19. ![Figure](https://substackcdn.com/image/fetch/$s_!RcdN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fab335034-190f-427e-85e8-7044886c3f26_819x572.png)
   - Caption: Figure 16: Annotated figure from ParallelBench: Understanding the Trade-offs of Parallel Decoding in Diffusion LLMs paper (https://arxiv.org/abs/2510.04767) showing the issue with parallel decoding.

20. ![Figure](https://substackcdn.com/image/fetch/$s_!QFcN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F99dd56ef-ed85-4197-8959-bec6059de9c7_2048x1295.png)
   - Caption: Figure 17: Benchmark performance of a (faster) diffusion LLM (Gemini Diffusion) versus a fast autoregressive LLM (Gemini 2.0 Flash-Lite). Based on the numbers reported in https://deepmind.google/models/gemini-diffusion/#capabilities.

21. ![Figure](https://substackcdn.com/image/fetch/$s_!d-nj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6c9567c7-aab2-4b1a-96c9-1c12b33bd340_2048x1213.png)
   - Caption: Figure 18: Conceptual overview of a world model system. The agent interacts with the environment by observing its current state(t) and taking action(t) to achieve a given objective. In parallel, the agent learns an internal world model, which serves as a mental simulation of the environment, which allows it to predict outcomes and plan actions before executing them in the real world.

22. ![Figure](https://substackcdn.com/image/fetch/$s_!2U7G!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff6408168-f7a2-4dc0-9848-8fd655056007_2048x1293.png)
   - Caption: Figure 19: Example of code execution tracing in the Code World Model (CWM). The model predicts how variable states evolve step by step as each line of code executes. Here, the model effectively simulates the code’s behavior. Annotated figure from https://www.arxiv.org/abs/2510.02387.

23. ![Figure](https://substackcdn.com/image/fetch/$s_!eziD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6b48ed35-65f9-484f-8c71-c1d2452b9b09_1381x876.png)
   - Caption: Figure 20: Performance of the code world model (CWM) compared to other popular LLMs on a coding benchmark (SWE-bench). Annotated figure from https://www.arxiv.org/abs/2510.02387.

24. ![Figure](https://substackcdn.com/image/fetch/$s_!5HQW!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fec39bd81-4e94-4134-bf7d-0c6fa8a55717_1140x721.png)
   - Caption: Figure 21: LLM landscape overview; this section small recursive transformers.

25. ![Figure](https://substackcdn.com/image/fetch/$s_!OPh1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F756f0d78-0997-42d0-9be0-2439ff46b1a5_2048x1861.png)
   - Caption: Figure 22: Example ARC-AGI 1 task (top) from arcprize.org/arc-agi/1 and the Hierarchical Reasoning Model (HRM) ranked on the leaderboard (bottom) from arcprize.org/blog/hrm-analysis.

26. ![Figure](https://substackcdn.com/image/fetch/$s_!aRJn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F67a717ab-c330-45d5-b710-f876fa368f6e_1950x2048.png)
   - Caption: Figure 23: The Tiny Recursive Model (TRM). Annotated figure from https://arxiv.org/abs/2510.04871.

27. ![Figure](https://substackcdn.com/image/fetch/$s_!9a2Q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4e6db3b8-d36f-4e5c-8204-c56b315cc7b8_1600x2048.png)

28. ![Figure](https://substackcdn.com/image/fetch/$s_!RCl_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27a118a0-5da6-4486-b1f0-3743754d0a77_8106x4044.webp)
