...
1. ![Figure](https://substackcdn.com/image/fetch/$s_!r0Sf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa420bd8a-891f-4577-8de8-4582de45e6ca_1600x949.png)
   - Caption: Annotated charts from the Pythia paper, https://arxiv.org/abs/2304.01373

2. ![Figure](https://substackcdn.com/image/fetch/$s_!HApV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F35f86db1-771a-4b2f-82cd-5daa732dbe4f_1190x828.png)
   - Caption: Annotated figure from Llama 2 paper (https://arxiv.org/abs/2307.09288) comparing Llama 2 models to ChatGPT

3. ![Figure](https://substackcdn.com/image/fetch/$s_!zw7c!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F29b1ac66-ff44-461d-95f3-8a9fb07b6562_1384x764.png)
   - Caption: Annotated figure from Llama 2 paper (https://arxiv.org/abs/2307.09288) summarizing the RLHF process for instruction finetuning.

4. ![Figure](https://substackcdn.com/image/fetch/$s_!kAkh!,w_140,h_140,c_fill,f_auto,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe06a33c8-cdbd-4f5e-8380-86fb71a075c8_2216x1232.png)
   - Caption: LLM Training: RLHF and Its Alternatives

5. ![Figure](https://substackcdn.com/image/fetch/$s_!GgGi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5628bf36-ac20-43fe-96aa-670cb8a5cac0_1600x782.png)
   - Caption: Annotated figure from Llama 2 paper (https://arxiv.org/abs/2307.09288) showing the performance progression from the first iteration of the supervised finetuned model (SFT-1) to the final RLHF-finetuned chat model (RLHF-v5).

6. ![Figure](https://substackcdn.com/image/fetch/$s_!JDYK!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe57930b6-afd0-48e6-90a6-97b5dcacb89f_1560x662.png)
   - Caption: A short visual summary of regular LoRA

7. ![Figure](https://substackcdn.com/image/fetch/$s_!KoWl!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F39daaf2c-4e5c-4075-8697-3c0a636f2144_1226x578.png)
   - Caption: Among the many efficient finetuning methods for LLMs, LoRA is among the most popular and widely used ones. Annotated figure from the excellent Scaling Down to Scale Up: A Guide to Parameter-Efficient Fine-Tuning survey. 

8. ![Figure](https://substackcdn.com/image/fetch/$s_!6WXp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F01911980-8546-4eaa-8a78-afe3582ba79c_1600x374.png)
   - Caption: Excerpt from my LoRA & QLoRA experiments that I wrote about previously here

9. ![Figure](https://substackcdn.com/image/fetch/$s_!zdFP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F40063902-cdd3-4dd9-9993-bb9b6f7e7663_1456x1126.jpeg)
   - Caption: The different ways of pretraining and finetuning LLMs.

10. ![Figure](https://substackcdn.com/image/fetch/$s_!Wdr3!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F09755a6f-ceb5-4011-8651-45ffffd260e5_1290x928.png)
   - Caption: Example of two training examples from a dataset for the supervised instruction finetuning step. Note that the "input" is optional.

11. ![Figure](https://substackcdn.com/image/fetch/$s_!4B-U!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3e8d2822-a23b-4e52-8ab7-ab2f513dcc06_1276x1034.png)
   - Caption: Annotated figures from the DPO paper, https://arxiv.org/abs/2305.18290

12. ![Figure](https://substackcdn.com/image/fetch/$s_!01O7!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a87d73e-af86-49bb-bd77-41585141b85d_1318x1226.png)
   - Caption: Annotated Benchmarks of the Zephyr model (a DPO-finetuned LLM) from https://arxiv.org/abs/2310.16944

13. ![Figure](https://substackcdn.com/image/fetch/$s_!o9Zm!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F830e5a05-663c-4b4b-9bbd-6d4f33a78c5b_1600x933.png)
   - Caption: Annotated figure from https://arxiv.org/abs/2310.06825 comparing Mistral 7B and Llama 13B performances

14. ![Figure](https://substackcdn.com/image/fetch/$s_!o4UR!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb36dd723-2a61-46aa-9020-e033e6fe31be_1600x858.png)
   - Caption: Annotated figure from https://arxiv.org/abs/2310.06825 explaining sliding window attention.

15. ![Figure](https://substackcdn.com/image/fetch/$s_!WxqV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F492d455d-9f0f-4c15-a0c7-0a3dec6f59a6_792x796.png)
   - Caption: OpenCompass benchmarks via https://github.com/open-compass/MixtralKit. Blue boxes highlight the best results in each row.

16. ![Figure](https://substackcdn.com/image/fetch/$s_!6UTD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd5e379db-3f34-4733-854a-f90987181118_844x726.png)
   - Caption: Mixtral architecture overview based on the param.json file that the Mistral team originally shared via a magnet link on social media

17. ![Figure](https://substackcdn.com/image/fetch/$s_!Kcs9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F77ee34dd-be4f-4d04-b898-9a1b32209023_1356x816.png)
   - Caption: Annotated figure from Switch Transformers paper (https://arxiv.org/abs/2101.03961) that explains mixture-of-experts architectures

18. ![Figure](https://substackcdn.com/image/fetch/$s_!MCMA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe558f722-7d35-4c63-b8ee-e5a492b8c189_1600x608.png)
   - Caption: Comparison between the 1.3B parameter phi-1.5 model and various 7B parameter models (via the phi-1.5 paper, https://arxiv.org/abs/2309.05463)

19. ![Figure](https://substackcdn.com/image/fetch/$s_!i-GY!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F06fe2b7c-35d2-4c84-b3f5-96d5e20ad1fa_1600x856.png)
   - Caption: Annotated figure based on the Self-Instruct paper, https://arxiv.org/abs/2212.10560

20. ![Figure](https://substackcdn.com/image/fetch/$s_!r9q8!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F48beb772-8412-4346-b425-f730ef05bfee_1558x694.png)
   - Caption: Annotated figure from the LIMA paper, https://arxiv.org/abs/2305.11206

21. ![Figure](https://substackcdn.com/image/fetch/$s_!lc2A!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fab02efdc-7254-41ab-8518-993db9734b98_1600x613.png)
   - Caption: A subset of the many benchmarks tasks evaluated in the Orca 2 paper, https://arxiv.org/abs/2311.11045

22. ![Figure](https://substackcdn.com/image/fetch/$s_!yIVT!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc505ad21-66db-4e98-977c-76da3098c1bf_1492x816.png)
   - Caption: Annotated figure from ConvNets Match Vision Transformers at Scale (https://arxiv.org/abs/2310.16764) paper 

23. ![Figure](https://substackcdn.com/image/fetch/$s_!-DiF!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F041ee20a-f6dc-4759-9291-efb5d4b48212_870x1026.jpeg)
   - Caption: Object detection (top) and segmentation (bottom). Figures from YOLO paper (https://arxiv.org/abs/1506.02640) and Mask R-CNN paper (https://arxiv.org/abs/1703.06870v3)

24. ![Figure](https://substackcdn.com/image/fetch/$s_!GhGw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcfa09c5e-0b4f-4984-95c2-13ce9cf8de1d_1304x670.jpeg)
   - Caption: The Segment Anything Model (SAM) is designed for efficient, prompt-based image segmentation. Annotated screenshot from the Segment Anything paper, https://arxiv.org/abs/2304.02643

25. ![Figure](https://substackcdn.com/image/fetch/$s_!VhXw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb49ed129-7492-4d65-b23d-d2b405057b9f_1600x592.png)
   - Caption: The three main components of the Segment Anything Model via https://arxiv.org/abs/2304.02643

26. ![Figure](https://substackcdn.com/image/fetch/$s_!TRuO!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe4387528-dadb-4b4d-8617-7af85571460a_1046x862.png)
   - Caption: Performance comparison between Emu and other text-to-video models via https://arxiv.org/abs/2311.10709

27. ![Figure](https://substackcdn.com/image/fetch/$s_!CxIZ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27b6d27d-1052-4a4f-a419-a69cdd36704a_1118x454.png)
...
Annotated figure from Switch Transformers paper (https://arxiv.org/abs/2101.03961) that explains mixture-of-experts architectures
...
Annotated figure from ConvNets Match Vision Transformers at Scale (https://arxiv.org/abs/2310.16764) paper 
...
The Segment Anything Model (SAM) is designed for efficient, prompt-based image segmentation. Annotated screenshot from the Segment Anything paper, https://arxiv.org/abs/2304.02643
...
The three main components of the Segment Anything Model via https://arxiv.org/abs/2304.02643
